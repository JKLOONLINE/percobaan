...
def main1():
    ...
    print '           \x1b[31m[\x1b[37mAuthor\x1b[31m]=[ \x1b[36mJENGKOLONLINE'
    print '           \x1b[31m[\x1b[37mCreate\x1b[31m]=[ \x1b[36m8 agustus 2023'
...
def pilih():
    ...
    if mana == '':
        ...
        chat.replace(' ', '%20')
        spin()
        sp.check_output(['am', 'start', 'https://api.whatsapp.com/send?phone=6282372139631&text=HASHER : ' + chat + ''])
        main()
    else:
        muat()
